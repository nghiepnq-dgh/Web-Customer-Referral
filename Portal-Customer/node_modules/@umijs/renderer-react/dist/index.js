...
function getRouteElement(_ref3) {
  ...
  if (route.redirect) {
    ...
    if (!opts.isServer && // make sure loaded once
...
function renderClient(opts) {
  ...
  if (opts.rootElement) {
    var rootElement = typeof opts.rootElement === 'string' ? document.getElementById(opts.rootElement) : opts.rootElement; // flag showing SSR successed

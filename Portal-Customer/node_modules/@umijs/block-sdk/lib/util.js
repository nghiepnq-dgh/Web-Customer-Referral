...
function _fetchUmiBlock() {
  _fetchUmiBlock = _asyncToGenerator(function* (url) {
    try {
      const _yield$got3 = yield (0, _utils().got)(url),
...
function _fetchCDNBlocks() {
  _fetchCDNBlocks = _asyncToGenerator(function* ({
    ...
    try {
      const _yield$got4 = yield (0, _utils().got)(`${prefixCDN}/${summary}`),
            body = _yield$got4.body;

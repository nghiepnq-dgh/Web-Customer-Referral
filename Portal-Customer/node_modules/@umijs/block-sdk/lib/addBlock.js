...
const debug = (0, _utils().createDebug)('umiui:block-sdk:addBlock');
...
function _getCtx() {
  _getCtx = _asyncToGenerator(function* (url, args = {}, api) {
    ...
    debug(`get url ${url}`);
    const ctx = yield (0, _download.getParsedData)(url, _objectSpread({}, (userConfig === null || userConfig === void 0 ? void 0 : userConfig.block) || {}, {}, args));

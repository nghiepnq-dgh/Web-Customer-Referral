...
function checkConflict(blockDeps, projectDeps) {
  ...
  Object.keys(blockDeps).forEach(dep => {
    ...
    } else if (!_utils().semver.intersects(projectDeps[dep], blockDeps[dep])) {
...
const getBlockGenerator = api => {
  ...
  return _temp = class BlockGenerator extends _utils().Generator {
    // 区块源目录路径（/tmp）
    // 相对 pages 的目录
    // 区块添加的目标路径
    // 添加到的路由
    ...
    constructor({
      ...
      this.isTypeScript = void 0;
      this.sourcePath = void 0;
      this.dryRun = void 0;
      this.path = void 0;
      this.blockFolderPath = void 0;
      this.routePath = void 0;
      this.blockName = void 0;
      this.isPageBlock = void 0;
      this.execution = void 0;
      this.needCreateNewRoute = void 0;
      this.blockFolderName = void 0;

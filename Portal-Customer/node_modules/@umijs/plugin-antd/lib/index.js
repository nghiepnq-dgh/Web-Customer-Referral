...
var _default = api => {
  ...
  if (opts === null || opts === void 0 ? void 0 : opts.config) {
    const _opts$config = opts === null || opts === void 0 ? void 0 : opts.config,
          locale = _opts$config.locale,
          otherConfig = _objectWithoutProperties(_opts$config, ["locale"]);

    if (locale) {
      api.logger.warn('Invalid locale configuration in antd.config, please use plug-in @umijs/plugin-locale');
    }

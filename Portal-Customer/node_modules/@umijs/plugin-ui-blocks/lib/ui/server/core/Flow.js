...
var _gitTasks = _interopRequireDefault(require("./tasks/gitTasks"));

var _filesTasks = _interopRequireDefault(require("./tasks/filesTasks"));
...
class Flow extends _events().EventEmitter {
  ...
  run(args) {
    ...
    return _asyncToGenerator(function* () {
      ...
      let hasBreak = false; // eslint-disable-next-line no-restricted-syntax
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          debug('Flow current task', name); // 用户取消任务
  ...
  registryTasks(args) {
    (args.files ? _filesTasks.default : _gitTasks.default).forEach(({
      name,
      task
    }) => {
      this.tasks.push({

...
var _default = (context, opts = {}) => {
  ...
  return {
    presets: [opts.env && [require('@babel/preset-env').default, _objectSpread({}, (0, _utils().mergeConfig)(defaultEnvConfig, toObject(opts.env)), {
      debug: opts.debug
    ...
    plugins: [require('@babel/plugin-syntax-top-level-await').default, // Necessary to include regardless of the environment because
    ...
    [require('@babel/plugin-transform-destructuring').default, {
      ...
      removeImport: true
    }], opts.reactRequire && [require.resolve('babel-plugin-react-require')], opts.dynamicImportNode && [require.resolve('babel-plugin-dynamic-import-node')], opts.autoCSSModules && [require.resolve('@umijs/babel-plugin-auto-css-modules')], opts.svgr && [require.resolve('babel-plugin-named-asset-import'), {
      loaderMap: {
        svg: {
    ...
    }) : []), opts.importToAwaitRequire && [require.resolve('@umijs/babel-plugin-import-to-await-require'), opts.importToAwaitRequire], opts.lockCoreJS3 && [require.resolve('@umijs/babel-plugin-lock-core-js-3'), opts.lockCoreJS3]].filter(Boolean)
  };
};

...
Object.defineProperty(exports, "UmiUI", {
  enumerable: true,
  get: function get() {
    return _ui().default;
  }
...
function _ui() {
  const data = _interopRequireDefault(require("@umijs/ui"));
...
var _default = api => {
  api.onStart( /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    if (process.env.UMI_UI !== 'none' && !api.userConfig.ssr && command === 'dev') {
      const umiUI = new (_ui().default)();

      const _yield$umiUI$start = yield umiUI.start({
        browser: false
      }),
            server = _yield$umiUI$start.server,

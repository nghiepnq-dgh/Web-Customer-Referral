 ...
 const handleClick = onItemClick
  ...
  const langMenu = (
    ...
    >
        ...
        <Menu.Item key={'vi-VN'} style={menuItemStyle}>
          <span role='img' aria-label={allLangUIConfig['vi-VN']?.label  || 'vi-VN'}>
            {allLangUIConfig['vi-VN']?.icon || "🌐"}
          </span>{' '}
          {allLangUIConfig['vi-VN']?.label || 'vi-VN'}
        </Menu.Item>
    </Menu>
  );
